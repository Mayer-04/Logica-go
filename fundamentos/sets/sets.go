...
func main() {
	// Creando un conjunto inicial con algunos elementos
	set := map[string]bool{
		"a": true,
		"b": true,
	}
	...
	// Creando un conjunto utilizando una estructura vacía para mayor eficiencia
	set2 := map[int]struct{}{
		1: {},
		2: {},
	}
	...
	// Comprobando si un elemento existe en el conjunto
	// El identificador en blanco _ se utiliza para descartar el valor
	_, exists := set3[2]
	fmt.Printf("¿El elemento 2 existe en el conjunto? %v\n", exists)

	// Obtener e imprimir todas las claves del conjunto
	for key := range set3 {
		fmt.Printf("Valor: %d\n", key)
	}

	// Ejemplo de uso de la función para convertir un slice en un conjunto
