...
* Funciones de orden superiro: Una función de orden superior es una función que acepta otra función como argumento,
y/o devuelve una función como resultado.
* Closure: En Go, un closure (o clausura) es una función anónima que se define dentro de otra función,
y que puede acceder y modificar variables definidas en el ámbito de la función externa.
*/
...
// TODO: Se debe incluir entre paréntesis los múltiples valores a retornar.
