...
// La estructura `Person` es pública porque su nombre comienza con mayúscula.
...
// Puede ser llamado desde otros paquetes.
...
func main() {
	...
	// Imprimimos los valores de la instancia. Los campos públicos se mostrarán, pero `hobbies` no porque es privado.
